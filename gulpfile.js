...
gulp.task('default', callback => {
  runSequence(['clean:images', 'clean:scripts', 'copy'], ['styles', 'imagemin', 'pug'], 'browser-sync', 'watch', callback);
});

gulp.task('build', callback => {
  runSequence(['clean:images', 'clean:scripts', 'copy'], ['styles', 'imagemin', 'pug'], ['htmlmin', 'revision'], callback);
});
